...
$user_role = $_SESSION['rol']; // Rol van de gebruiker (admin of niet)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete']) && is_numeric($_POST['delete'])) {
    ...
    // Als de gebruiker admin is, kan hij/zij elk bericht verwijderen
    if ($user_role === 'admin') {
        ...
        // Alleen berichten verwijderen die door de ingelogde gebruiker zijn geplaatst
    ...
    <?php else: ?>
        <?php foreach ($messages as $message): ?>
            <div class="message">
                ...
                <!-- Verwijder knop (alleen voor berichten van de gebruiker zelf of beheerders) -->
